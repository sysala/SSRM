function omega=damping(it_damp_max,U_it,dU,F,f,B,WEIGHT,c_bar,sin_phi,shear,bulk,lame)
...
%--------------------------------------------------------------------------
  ...
  while it_damp<it_damp_max
    ...
    S_omega=constitutive_problem(E_omega,c_bar,sin_phi,shear,bulk,lame);
